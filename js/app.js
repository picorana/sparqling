...
(function() {
    ...
    SparqlText.prototype.update = function() {
      ...
      for (k = 0, len1 = ref.length; k < len1; k++) {
        ...
        for (m = 0, len3 = ref2.length; m < len3; m++) {
          node2 = ref2[m];
          ref3 = node2.neighborhood(".node-link");
  ...
  window.PainlessLink = (function() {
    var cy, link_name, link_type, node_link, node_quad1, node_quad2, node_var1, node_var2;
    ...
    PainlessLink.prototype.create = function() {
      ...
      this.node_link = this.create_node('node-link', this.link_name);
  ...
  window.PainlessGraph = (function() {
     ...
     */
    var cur_variable_value, sparql_text, state_buffer, state_buffer_max_length;
