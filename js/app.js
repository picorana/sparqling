...
window.SparqlText = (function() {
  ...
  class SparqlText {
    constructor(cy, links) {
      ...
      this.create_query_line = this.create_query_line.bind(this);
    ...
    update() {
      var count, elem, f_string, init_string, j, k, len, len1, link, ref, s_line, select_div, select_div_f;
      ...
      for (k = 0, len1 = ref.length; k < len1; k++) {
        link = ref[k];
        div_sparql_text.append(this.create_query_line(link));
      }
