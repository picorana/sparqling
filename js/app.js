...
window.SparqlText = (function() {
  ...
  class SparqlText {
    constructor(cy, links) {
      ...
      this.dragslot_drop = this.dragslot_drop.bind(this);
      this.create_dragslot = this.create_dragslot.bind(this);
    ...
    create_dragslot(index) {
      ...
      nbsp.addEventListener('drop', (ev) => {
        return this.dragslot_drop(ev, nbsp.dataset.index);
      });
      nbsp.innerHTML = '&nbsp;&nbsp;';
      return nbsp;
    }
