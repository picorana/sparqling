...
(function() {
  var add_role, check_collisions, class_cur_letter, compute_distance, cy, elements, generate_style, init, merge, randomize, reshape, reshape2, save_state, sparql_text, state_buffer, state_buffer_max_length, undo, update_sparql_text;
  ...
  cy.on('mouseup', function($) {
    ...
    if (check_collisions() !== void 0) {
      ...
      return merge(node_tmp_arr[0], node_tmp_arr[1]);
    }
  });
