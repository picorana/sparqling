    ...
    node_variable_context_menu = {
      ...
      commands: [
        ...
        },
        {
          ...
          select: (ele) => {
            return this.add_to_select(ele.id());
          }
        },
        {
          content: 'rename node'
  ...
  class PainlessGraph {
    constructor() {
      ...
      */
      ...
      new window.PainlessContextMenu(this.cy);
    }
...
window.PainlessLink = class PainlessLink {
  ...
  create_link() {
    ...
    this.create_edge(this.source, this.node_link, "source-edge");
    return this.create_edge(this.node_link, this.target, "target-edge");
  }
